...
from kinodata.data import PROCESSED_DATA_DIR
from kinodata.transform import FilterDockingRMSD
from pathlib import Path


if __name__ == "__main__":
    full_dataset = KinodataDocked(use_multiprocessing=True)
    full_dataset.df.to_csv(PROCESSED_DATA_DIR / "kinodata3d_v2.csv", index=False)
