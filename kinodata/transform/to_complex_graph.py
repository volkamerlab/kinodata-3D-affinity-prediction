...
class TransformToComplexGraph(BaseTransform):
    ...
    def __call__(self, data: HeteroData) -> HeteroData:
        ...
        ligand_edge_store = data[NodeType.Ligand, RelationType.Covalent, NodeType.Ligand]
        pocket_edge_store = data[NodeType.Pocket, RelationType.Covalent, NodeType.Pocket]
